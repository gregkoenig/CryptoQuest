...
import com.dmgctrll.OnLetterChangedListener;
	...
	public class LetterPickerView extends View {
	
	 
	        private final Paint mPaint;
	        private final Paint mCenterPaint;
	        private final int[] mColors;
	        private final OnLetterChangedListener mListener;

	        LetterPickerView(Context c, OnLetterChangedListener l, int color) {
	            super(c);
	            mListener = l;
	        ...
	        public boolean onTouchEvent(MotionEvent event) {
	            ...
	            case MotionEvent.ACTION_UP:
	                if (mTrackingCenter) {
	                    if (inCenter) {
	                        //mListener.letterChanged(mCenterPaint.getChar());
	                    }
